...
#define CUSTOM_MACHINE_NAME "QR2-KNOB"
...
#if (EXTRUDERS > 1) && DISABLED(SINGLENOZZLE) && DISABLED(MIXING_EXTRUDER)
#define TEMP_SENSOR_1 	5
#else
#define	TEMP_SENSOR_1	0
#endif

#if (EXTRUDERS > 2) && DISABLED(SINGLENOZZLE) && DISABLED(MIXING_EXTRUDER)
#define TEMP_SENSOR_2 	5
#else
#define	TEMP_SENSOR_2	0
#endif

#if (EXTRUDERS > 3) && DISABLED(SINGLENOZZLE) && DISABLED(MIXING_EXTRUDER)
#define TEMP_SENSOR_3 	5
#else
#define	TEMP_SENSOR_3	0
#endif

#if (EXTRUDERS > 4) && DISABLED(SINGLENOZZLE) && DISABLED(MIXING_EXTRUDER)
#define TEMP_SENSOR_4 	5
#else
#define	TEMP_SENSOR_4	0
#endif

#if DISABLED(TEMP_SENSOR_BED) && DISABLED(DISABLED_HEATBED)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 79.27, 400, 126 }//{ 80, 80, 400, 85 }
...
#ifndef DISTANCE_TO_CORNER_X
#define	DISTANCE_TO_CORNER_X	20	//mm the distance to real corner of bed
#endif

#ifndef DISTANCE_TO_CORNER_Y
#define	DISTANCE_TO_CORNER_Y	20	//mm the distance to real corner of bed
#endif
...
//
#define ZONESTAR_LCD2004_KNOB            // Requires ADC_KEYPAD_PIN to be assigned to an analog pin.
